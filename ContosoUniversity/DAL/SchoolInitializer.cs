...
namespace ContosoUniversity.DAL
{
    public class SchoolInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<SchoolContext>
    {
        ...
        // The databaseinitializer type specifies the fully qualified name of the initializer class and the assembly it's in
        ...
        // Automatically called by Entity Framework after creating the database in order to populate it with test data
        protected override void Seed(SchoolContext context)
        {
            ...
            // add each item in students List using a lambda
            students.ForEach(s => context.Students.Add(s));
            // saving after each group of entities assists with debugging
            context.SaveChanges();
